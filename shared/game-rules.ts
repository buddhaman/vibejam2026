...
export const UNIT_RULES = {
  [UnitType.VILLAGER]: {
    ...
    cost: { biomass: 45, material: 0, compute: 0 },
    trainTimeMs: 7500,
    health: 55,
    unitCount: 1,
    visualScale: 0.82,
  ...
  [UnitType.WARBAND]: {
    ...
    cost: { biomass: 120, material: 36, compute: 72 },
    trainTimeMs: 16800,
    health: 11,
    unitCount: 12,
    visualScale: 1,
  ...
  [UnitType.ARCHER]: {
    ...
    cost: { biomass: 80, material: 20, compute: 50 },
    trainTimeMs: 12000,
    health: 8,
    unitCount: 10,
    visualScale: 0.96,
  ...
  [UnitType.SYNTHAUR]: {
    ...
    cost: { biomass: 126, material: 30, compute: 96 },
    trainTimeMs: 13200,
    health: 18,
    unitCount: 6,
    visualScale: 1.18,
