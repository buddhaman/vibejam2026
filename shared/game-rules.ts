...
export const GAME_RULES = {
  ...
  /** Release is intentionally fast; dev can override this to be much faster. */
  UNIT_TRAIN_TIME_MULTIPLIER: 1.35,
  ...
  FARM_HEALTH: 120,
  TOWER_HEALTH: 300,
  TOWER_ATTACK_RANGE: 48,
  TOWER_DAMAGE_PER_SEC: 7,
...
export const UNIT_RULES = {
  [UnitType.VILLAGER]: {
    ...
    cost: { biomass: 90, material: 0, compute: 0 },
    trainTimeMs: 7500,
    health: 55,
    unitCount: 3,
    visualScale: 0.82,
  ...
  [UnitType.WARBAND]: {
    ...
    cost: { biomass: 220, material: 64, compute: 112 },
    trainTimeMs: 19000,
    health: 11,
    unitCount: 32,
    visualScale: 1,
    dpsPerUnit: 0.42,
    meleeDpsPerUnit: 0.42,
    targetSize: 32,
  ...
  [UnitType.ARCHER]: {
    ...
    cost: { biomass: 150, material: 36, compute: 84 },
    trainTimeMs: 16500,
    health: 8,
    unitCount: 24,
    visualScale: 0.96,
  ...
  [UnitType.SYNTHAUR]: {
    ...
    cost: { biomass: 196, material: 42, compute: 140 },
    trainTimeMs: 18000,
    health: 18,
    unitCount: 14,
    visualScale: 1.18,
    dpsPerUnit: 0.95,
    meleeDpsPerUnit: 0.95,
    targetSize: 28,
