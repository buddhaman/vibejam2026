...
const COMBAT_TARGET_STANDOFF = GAME_RULES.UNIT_RADIUS * 2.35;
const COMBAT_ATTACK_ENTER_DISTANCE = GAME_RULES.UNIT_RADIUS * 2.1;
const COMBAT_ZONE_PADDING = GAME_RULES.UNIT_RADIUS * 2.8;
const COMBAT_TARGET_SEARCH_RADIUS = 6;
const COMBAT_TARGET_SIDE_SPACING = GAME_RULES.UNIT_RADIUS * 1.02;
const COMBAT_JITTER_RADIUS = GAME_RULES.UNIT_RADIUS * 0.9;
